...
const handleSubmit = async () => {
  ...
  try {
    ...
    message.value =
      'Signed in successfully! Cookie set. <br><button onclick="testMe()" class="mt-2.5 px-4 py-2 bg-green-600 text-white border-none rounded cursor-pointer">Test /me endpoint</button>';
